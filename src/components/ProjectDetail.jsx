...
      text: 'O código fonte deste projeto é privado, mas os detalhes técnicos estão abaixo.', 
            ...
            <div className="space-y-6 md:space-y-10 animate-slideInLeft">
              ...
              <div className="flex flex-wrap gap-3 md:gap-4">
                ...
                >
                  ...
                  <span className="relative font-medium">Ver Demonstração</span>
                </a>
...
                  src={project.Img}
                  alt={project.Title}
                  className="max-h-96 w-auto object-contain mx-auto block transform transition-transform duration-700 will-change-transform group-hover:scale-105"
