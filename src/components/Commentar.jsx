    ...
    >
        {isPinned && (
            <div className="flex items-center gap-2 mb-3 text-indigo-400">
                ...
                <span className="text-xs font-medium uppercase tracking-wide">Comentário Fixado</span>
            </div>
        )}
...
const Komentar = () => {
    ...
    const handleCommentSubmit = useCallback(async ({ newComment, userName, imageFile }) => {
        ...
        try {
            ...
            setError('Falha ao publicar o comentário. Por favor, tente novamente.');
...
        // Mantém o formato internacional (ou mude para 'pt-BR' se preferir)
                ...
                <div className="space-y-4 h-[328px] overflow-y-auto overflow-x-hidden custom-scrollbar pt-1 pr-1 " data-aos="fade-up" data-aos-delay="200">
                    ...
                    {comments.length === 0 && !pinnedComment ? (
                        <div className="text-center py-8" data-aos="fade-in">
                            ...
                            <p className="text-gray-400">Nenhum comentário. Seja o primeiro a iniciar a conversa!</p>
                        </div>
                    ) : (
