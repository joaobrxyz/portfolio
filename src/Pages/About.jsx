...
const AboutPage = () => {
  ...
  const { totalProjects, totalCertificates, YearExperience } = useMemo(() => {
    ...
    const experience = today.getFullYear() - startDate.getFullYear() -
      (today < new Date(today.getFullYear(), startDate.getMonth(), startDate.getDate()) ? 1 : 0) + "y";
  ...
  const statsData = useMemo(() => [
    {
      ...
      value: totalProjects,
      label: "Projetos",
      description: "Soluções full-stack desenvolvidas",
    ...
    },
    {
      ...
      label: "Certificados",
      description: "Habilidades técnicas validadas",
      animation: "fade-up",
    },
    {
      icon: Globe,
        ...
        <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div className="space-y-6 text-center lg:text-left">
            ...
            <p 
              ...
              data-aos-duration="1500"
            >
              Sou um desenvolvedor <strong>Full Stack</strong> com ênfase em arquitetura <strong>Backend</strong>, especializado em <strong>Java</strong> e <strong>Spring Boot</strong>. Possuo experiência prática com <strong>Angular</strong>, <strong>Bootstrap</strong> e meus projetos são completos (Full Stack), garantindo que minhas APIs sejam construídas para integrações eficientes.
              </p>
