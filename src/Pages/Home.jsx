...
const WORDS = ["Especialista em API RESTful", "Desenvolvedor Spring Boot", "Arquiteto Backend"];
const TECH_STACK = ["Java", "Spring Boot", "REST APIs", "MongoDB/SQL", "JWT Security"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/joaobrxyz" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/joaovitorgdasilva" }
];
            ...
            <div className="w-full lg:w-1/2 space-y-6 sm:space-y-8 text-left lg:text-left order-1 lg:order-1 lg:mt-0"
              ...
              <div className="space-y-4 sm:space-y-6">
                ...
                <p className="text-base md:text-lg text-gray-400 max-w-xl leading-relaxed font-light"
                  data-aos="fade-up"
                  data-aos-delay="1000">
                  Criando APIs robustas e seguras com Java e Spring Boot. Foco em arquitetura limpa, segurança (JWT/RBAC) e soluções escaláveis para o Backend.
                </p>
